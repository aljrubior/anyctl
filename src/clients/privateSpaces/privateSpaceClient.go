...
type PrivateSpaceClient interface {
	GetPrivateSpaces(token string) (*response.PrivateSpacesResponse, error)
	GetPrivateSpace(token, privateSpaceId string) (*response.PrivateSpaceResponse, error)
	GetPrivateSpacesByNameOrId(token string, privateSpaceId string) (*response.PrivateSpacesResponse, error)
